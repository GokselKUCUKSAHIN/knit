...
func BadRequestErrf(format string, a ...any) error {
	return makeCustomErr(http.StatusBadRequest, fmt.Sprintf(format, a...), badRequestFoundTitle)
}
...
func InternalServerErrf(format string, a ...any) error {
	return makeCustomErr(http.StatusInternalServerError, fmt.Sprintf(format, a...), internalServerErrorTitle)
}
...
func NotFoundErrf(format string, a ...any) error {
	return makeCustomErr(http.StatusNotFound, fmt.Sprintf(format, a...), resourceNotFoundTitle)
}
